...
{	
  ...
  void loaddir()
  {
    ...
    if ( idata[n][strlen( idata[n] )-1 ] == 'p' )
    if ( idata[n][strlen( idata[n] )-2 ] == 'p' )
    ...
    if ( idata[n][strlen( idata[n] )-4 ] == '.' )
    {
          ...
          // fltk-config --use-images --compile load-jpeg.cxx
            strncpy( cmdi, 
       //     "  fltk-config --use-images --compile  " 
    " g++ -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/arm-linux-gnueabihf/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libdrm -I/usr/include/libpng12 -I/usr/include/freetype2 -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/arm-linux-gnueabihf/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libdrm -I/usr/include/libpng12 -g -O2 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -D_THREAD_SAFE -D_REENTRANT  -lfltk_images -lfltk -lX11 "
