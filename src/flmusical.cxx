...
void BrowserCallback(Fl_Widget *w, void *data) 
{
  ...
  {  
         ...
         char cmdi[PATH_MAX];
         printf("SYS CALL MUSIC: %s\n", myfile );
         strncpy( cmdi, "", PATH_MAX );
         strncat( cmdi , "  pkill mpg123 ; sleep 1s ;  cd  " , PATH_MAX - strlen( cmdi ) -1 );
         strncat( cmdi , " \"" , PATH_MAX - strlen( cmdi ) -1 );
         strncat( cmdi , myfile , PATH_MAX - strlen( cmdi ) -1 );
         strncat( cmdi , "\" ; mpg123 *  " , PATH_MAX - strlen( cmdi ) -1 );
         strncat( cmdi , "  &  " , PATH_MAX - strlen( cmdi ) -1 );
         printf( "<CMD: %s>\n", cmdi );
         system( cmdi );
  }
...
int main()
{
    ...
    Fl_Window win(300, 400, "FLMUSICAL");
